...
class FishDataPreviewProvider {
    ...
    static let fishData1 = FishData(scientificName: "Myripristis amaena", commonName: "Brick soldierfish", familyName: "Holocentriformes", title: "Patli Machli", count: 0, articleURL: "https://www.fishbase.org.au/v4/summary/7773", imageData: UIImage(named: "fishPlaceholder")!.pngData()!, imageURL: "https://www.fishbase.org.au/v4/images/species/Myama_u6.jpg", dateTime: Date().timeIntervalSince1970, hasTitle: true, hasNote: false, hasCount: false)
